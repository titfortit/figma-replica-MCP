  ...
  return (
    <div className="bg-[#f9f9f9] relative size-full min-h-screen flex items-center justify-center">
      ...
      >
        ...
        {/* Main Content Area */}
        <div
          className={`bg-[#f3f7ff] flex flex-col items-center justify-center transition-all ${isMobile ? 'gap-8 p-6' : 'gap-16 px-48 py-16'
            }`}
          style={{ height: isMobile ? 'calc(100% - 52px)' : 'calc(100% - 52px)' }}
        >
          {/* Components Row */}
